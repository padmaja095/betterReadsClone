package BetterreadsApp.betterreads.user;
...
public class BooksByUser {
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((authorNames == null) ? 0 : authorNames.hashCode());
        result = prime * result + ((bookId == null) ? 0 : bookId.hashCode());
        result = prime * result + ((bookName == null) ? 0 : bookName.hashCode());
        result = prime * result + ((coverIds == null) ? 0 : coverIds.hashCode());
        result = prime * result + ((coverUrl == null) ? 0 : coverUrl.hashCode());
        result = prime * result + ((id == null) ? 0 : id.hashCode());
        result = prime * result + rating;
        result = prime * result + ((readingStatus == null) ? 0 : readingStatus.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (bookName == null) {
            ...
            return false;
        if (coverIds == null) {
            if (other.coverIds != null)
                return false;
        } else if (!coverIds.equals(other.coverIds))
            return false;
        if (coverUrl == null) {
        ...
        if (readingStatus == null) {
            if (other.readingStatus != null)
                return false;
        } else if (!readingStatus.equals(other.readingStatus))
            return false;
        if (timeUuid == null) {
